...
export const Topbar = ({titulo,notifOpen,setNotifOpen,notifs,onNovaOS}) => (
  <div style={{background:C.surface,borderBottom:`1px solid ${C.border}`,padding:"0 24px",height:58,display:"flex",alignItems:"center",justifyContent:"space-between",position:"sticky",top:0,zIndex:5}}>
    <h1 style={{fontSize:16,fontWeight:700,color:C.text,margin:0}}>{titulo}</h1>
    <div style={{display:"flex",gap:9,alignItems:"center"}}>
      <div style={{position:"relative"}}>
        ...
        {notifOpen&&<div style={{position:"absolute",right:0,top:42,width:350,background:C.card,border:`1px solid ${C.border}`,borderRadius:12,boxShadow:"0 8px 32px #00000066",zIndex:100,maxHeight:400,overflowY:"auto"}}>
      ...
      <Btn onClick={onNovaOS}>+ Nova OS</Btn>
    </div>
  </div>
);
