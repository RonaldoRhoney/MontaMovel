...
export const DEMO = {
  ...
  fabricantes: [
    { id: "f1",  nome: "Madesa",         cidade: "Bento Gonçalves", estado: "RS", categorias: ["quarto","guarda-roupa"], telefone: "", email: "", ativo: true },
    { id: "f2",  nome: "Bertolini",      cidade: "Bento Gonçalves", estado: "RS", categorias: ["quarto","cozinha"],      telefone: "", email: "", ativo: true },
    { id: "f3",  nome: "Rudnick",        cidade: "Videira",         estado: "SC", categorias: ["quarto","guarda-roupa"], telefone: "", email: "", ativo: true },
    { id: "f4",  nome: "Henn",           cidade: "Arroio do Meio",  estado: "RS", categorias: ["cozinha","quarto"],      telefone: "", email: "", ativo: true },
    { id: "f5",  nome: "Dellano Móveis", cidade: "Bento Gonçalves", estado: "RS", categorias: ["quarto","sala"],         telefone: "", email: "", ativo: true },
    { id: "f6",  nome: "Kappesberg",     cidade: "Videira",         estado: "SC", categorias: ["cozinha","quarto"],      telefone: "", email: "", ativo: true },
    { id: "f7",  nome: "Casatema",       cidade: "Bento Gonçalves", estado: "RS", categorias: ["quarto","guarda-roupa"], telefone: "", email: "", ativo: true },
    { id: "f8",  nome: "Politorno",      cidade: "Bento Gonçalves", estado: "RS", categorias: ["quarto","sala"],         telefone: "", email: "", ativo: true },
    { id: "f9",  nome: "Bosi Móveis",    cidade: "Ubá",             estado: "MG", categorias: ["quarto","guarda-roupa"], telefone: "", email: "", ativo: true },
    { id: "f10", nome: "Móveis Carraro", cidade: "Bento Gonçalves", estado: "RS", categorias: ["sala","escritorio"],     telefone: "", email: "", ativo: true },
    { id: "f11", nome: "Demobile",       cidade: "Ubá",             estado: "MG", categorias: ["quarto","cozinha"],      telefone: "", email: "", ativo: true },
    { id: "f12", nome: "Art in Móveis",  cidade: "Ubá",             estado: "MG", categorias: ["quarto","guarda-roupa"], telefone: "", email: "", ativo: true },
    { id: "f13", nome: "Pallazio",       cidade: "Ubá",             estado: "MG", categorias: ["sala","quarto"],         telefone: "", email: "", ativo: true },
    { id: "f14", nome: "Multimóveis",    cidade: "Ubá",             estado: "MG", categorias: ["cozinha","quarto"],      telefone: "", email: "", ativo: true },
    { id: "f15", nome: "Imcal Móveis",   cidade: "Ubá",             estado: "MG", categorias: ["quarto","guarda-roupa"], telefone: "", email: "", ativo: true },
    { id: "f16", nome: "Moval",          cidade: "Ubá",             estado: "MG", categorias: ["sala","quarto"],         telefone: "", email: "", ativo: true },
    { id: "f17", nome: "Todeschini",     cidade: "Bento Gonçalves", estado: "RS", categorias: ["planejados","cozinha"],  telefone: "", email: "", ativo: true },
    { id: "f18", nome: "Herval",         cidade: "Rio Negrinho",    estado: "SC", categorias: ["colchões","estofados"],  telefone: "", email: "", ativo: true },
    { id: "f19", nome: "Probel",         cidade: "Várzea Paulista", estado: "SP", categorias: ["colchões"],              telefone: "", email: "", ativo: true },
    { id: "f20", nome: "Ortobom",        cidade: "Duque de Caxias", estado: "RJ", categorias: ["colchões"],              telefone: "", email: "", ativo: true },
  ],
  pedidos: [
    { id: "pe1", numero_pedido: "PED-10234", data_compra: "2026-07-10", valor: 1899.9, canal_origem: "ERP Loja Belém", utilizado: false,
      cliente_id: "c1", produto_id: "p1", produto_descricao: null,
      clientes: { nome: "Fernanda Lima", telefone: "(91) 98888-1111", logradouro: "Av. Nazaré", numero: "1200", complemento: "Apto 302", bairro: "Nazaré", cidade: "Belém", estado: "PA", cep: "66035-170" },
      produtos: { nome: "Guarda-Roupa 6 Portas" } },
    { id: "pe2", numero_pedido: "PED-10235", data_compra: "2026-07-12", valor: 899.0, canal_origem: "ERP Loja Belém", utilizado: false,
      cliente_id: "c2", produto_id: "p2", produto_descricao: null,
      clientes: { nome: "Roberto Alves", telefone: "(91) 98888-2222", logradouro: "Tv. Padre Eutíquio", numero: "540", complemento: "", bairro: "Marco", cidade: "Belém", estado: "PA", cep: "66033-000" },
      produtos: { nome: "Cama Box Casal" } },
    { id: "pe3", numero_pedido: "PED-10201", data_compra: "2026-06-28", valor: 620.5, canal_origem: "ERP Loja Belém", utilizado: true,
      cliente_id: "c3", produto_id: "p3", produto_descricao: null,
      clientes: { nome: "Juliana Cardoso", telefone: "(91) 98888-3333", logradouro: "Rua dos Mundurucus", numero: "88", complemento: "", bairro: "Umarizal", cidade: "Belém", estado: "PA", cep: "66050-350" },
      produtos: { nome: "Armário de Cozinha" } },
  ],
  ordens_servico: [
...
export const DEMO_RPC = {
  ...
  seed_fabricantes_padrao: 0, // no demo já vêm todos populados
  relatorio_assistencias_por_fabricante: [
    { fabricante_id: "f9", fabricante_nome: "Bosi Móveis", total: 4 },
    { fabricante_id: "f1", fabricante_nome: "Madesa", total: 3 },
    { fabricante_id: "f3", fabricante_nome: "Rudnick", total: 2 },
    { fabricante_id: "f18", fabricante_nome: "Herval", total: 1 },
  ],
};
